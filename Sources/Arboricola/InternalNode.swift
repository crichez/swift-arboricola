...
class InternalNode<Key: Comparable, Value>: Collection {
    class Record {
        ...
        init(node: Node<Key, Value>, separator: Key, next: Next) {
            self.node = node
    ...
    func insert(node: Node<Key, Value>, separatedBy key: Key) -> (inserted: Bool, exceededCapacity: Bool) {
